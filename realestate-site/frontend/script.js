...
(function initListingsFilter() {
  ...
  function updateFilterBadges() {
    ...
    if (resetBtn) {
      ...
      if (label) label.textContent = totalCount > 0 ? `پاک همه (${totalCount})` : "پاک همه";
    }
  }
  ...
  if (cityInput) {
    ...
    // تایپ زنده هم روی دکمه «پاک همه» اثر بگذارد، حتی قبل از زدن جستجو
    cityInput.addEventListener("input", () => updateFilterBadges());
  }
